...
export function AgentIAMControls(props) {
  ...
  createEffect(() => {
    ...
    if (!ag) return;
    const iamMap = cloudIAMData()?.agents;
    const currentAgentIAM = iamMap?.[ag.id];

    if (currentAgentIAM) {
      setFormData(JSON.parse(JSON.stringify(currentAgentIAM)));
    } else {
      setFormData({
        agentId: ag.id,
        agentName: ag.name,
  ...
  const projectId = createMemo(() => cloudOverview()?.gcp?.projectId || 'qwiklabs-gcp-02-26c698bb5fef');
  const serviceAccountsList = createMemo(() => cloudIAMData()?.gcpServiceAccounts || [
  ...
  async function handleSave() {
    ...
    try {
      const res = await dashboardState.updateAgentIAMConfig(props.agent.id, JSON.parse(JSON.stringify(formData)));
      if (res && res.success) {
        setSaveSuccess(true);
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-slate-900/60 border border-slate-800 rounded-xl p-5 space-y-4">
          ...
          <div class="space-y-3.5 text-xs">
            <div>
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  setFormData('serviceAccount', val);
                  setFormData('identityType', val.includes('shared') || val.includes('customer-sa') ? 'shared' : 'dedicated');
                }}
            ...
            <div class="space-y-2">
              <span class="block text-slate-400 font-medium">Assigned Least-Privilege IAM Roles</span>
          ...
          <div class="space-y-4 text-xs">
            ...
            <div>
              ...
              <input
                ...
                onInput={(e) => setFormData('bigqueryQuota', 'maxScanBytesPerQueryGB', Number(e.target.value))}
            ...
            <div>
              ...
              <input
                ...
                onInput={(e) => setFormData('bigqueryQuota', 'dailyCostBudgetUSD', Number(e.target.value))}
            ...
            <div class="grid grid-cols-2 gap-3 pt-1">
              <div class="p-2.5 rounded-lg bg-slate-950 border border-slate-800 flex items-center justify-between">
                ...
                <button
                  onClick={() => {
                    setFormData('bigqueryQuota', 'scope', formData.bigqueryQuota.scope === 'read_only' ? 'read_write' : 'read_only');
                  }}
              ...
              <div class="p-2.5 rounded-lg bg-slate-950 border border-slate-800 flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e) => setFormData('bigqueryQuota', 'autoCancelHeavyQueries', e.target.checked)}
          ...
          <div class="space-y-4 text-xs">
            <div>
              ...
              <div class="grid grid-cols-2 gap-2">
                <button
                  type="button"
                  onClick={() => setFormData('ingressControl', 'policy', 'authorized_only')}
                ...
                <button
                  type="button"
                  onClick={() => setFormData('ingressControl', 'policy', 'public')}
            ...
            <div class="p-3 bg-slate-950 border border-slate-800 rounded-lg flex items-center justify-between">
              ...
              <input
                ...
                onChange={(e) => setFormData('ingressControl', 'modelArmorScreening', e.target.checked)}
            ...
            <div>
              ...
              <input
                ...
                onInput={(e) => setFormData('ingressControl', 'maxInstances', Number(e.target.value))}
          ...
          <div class="space-y-4 text-xs">
            ...
            <div>
              ...
              <input
                ...
                onInput={(e) => setFormData('finopsBudget', 'monthlyCeilingUSD', Number(e.target.value))}
            ...
            <div class="p-3 bg-slate-950 border border-slate-800 rounded-lg flex items-center justify-between">
              ...
              <input
                ...
                onChange={(e) => setFormData('finopsBudget', 'hardStopCircuitBreaker', e.target.checked)}
